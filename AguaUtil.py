    ...
    for item in dpto:
        ...
        for ctr in centroides:
            ...
            if dic['clt'] == 'TL':
                    ...
                    f_ctr = [s for s in dfiles if ndecafile1 in s or ndecafile2 in s]
            ...
            if f_ctr:
                ...
                df_c = df_s[np.logical_and(dp3['PRDPT'] == item,
                                           dp3['centroide'] == ctr)]
...
def main():
    ...
    fdeca = dt.datetime(2019, 6, 11).strftime('%d%m%Y')
    path = 'e:/python/AguaUtil/Balances/20190623/'
    opath = 'e:/python/AguaUtil/'
    au_folder = 'AU'
    deca_folder = opath + 'Decadales/decadal20190623/'
